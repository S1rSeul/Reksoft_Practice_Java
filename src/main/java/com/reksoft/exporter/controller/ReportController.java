...
public class ReportController {
    ...
    public ResponseEntity<Resource> downloadPlayerReport() throws IOException {
        return buildReportResponse("player_report", playerReportService);
    }

    @GetMapping("/team/download")
    public ResponseEntity<Resource> downloadTeamReport() throws IOException {
        return buildReportResponse("team_report", teamReportService);
    }

    private ResponseEntity<Resource> buildReportResponse(String filePrefix, CsvReportService reportService) throws IOException {
        ...
        File reportFile = reportService.generateReport(
